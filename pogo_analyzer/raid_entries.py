...
RAID_ENTRIES: List[PokemonRaidEntry] = [
    PokemonRaidEntry(
        "Snover",
        (14, 12, 14),
...
__all__ = ["PokemonRaidEntry", "RAID_ENTRIES", "build_rows"]
